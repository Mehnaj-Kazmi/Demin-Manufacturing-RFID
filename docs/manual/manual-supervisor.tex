% ===========================================================================
%  Supervisor Portal - standalone manual
%  Build:  pdflatex manual-supervisor.tex      (run it twice so the contents page is right)
% ===========================================================================
\documentclass[11pt,a4paper,oneside]{report}
\usepackage{style/manualstyle}

\hypersetup{pdftitle={Denim RFID Track and Trace - Supervisor Portal}}

\begin{document}

\begin{titlepage}
\begin{tikzpicture}[remember picture,overlay]
  \fill[secSort] (current page.north west) rectangle ([yshift=-95mm]current page.north east);
  ...
  \node[anchor=north west,text=white,font=\LARGE,align=left]
    at ([xshift=25mm,yshift=-66mm]current page.north west) {Supervisor Portal};
  \node[anchor=south east,text=brandgrey,font=\small,align=right]
    at ([xshift=-25mm,yshift=25mm]current page.south east) {Section workload \textbullet\ Settling count differences\\Cancelling handovers \textbullet\ Building reports};
\end{tikzpicture}

\vspace*{110mm}

{\Large\bfseries For the person in charge of a department}
