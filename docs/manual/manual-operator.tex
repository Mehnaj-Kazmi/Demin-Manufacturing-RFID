% ===========================================================================
%  Operator Portal - standalone manual
%  Build:  pdflatex manual-operator.tex      (run it twice so the contents page is right)
% ===========================================================================
\documentclass[11pt,a4paper,oneside]{report}
\usepackage{style/manualstyle}

\hypersetup{pdftitle={Denim RFID Track and Trace - Operator Portal}}

\begin{document}

\begin{titlepage}
\begin{tikzpicture}[remember picture,overlay]
  \fill[secStitch] (current page.north west) rectangle ([yshift=-95mm]current page.north east);
  ...
  \node[anchor=north west,text=white,font=\LARGE,align=left]
    at ([xshift=25mm,yshift=-66mm]current page.north west) {Operator Portal};
  \node[anchor=south east,text=brandgrey,font=\small,align=right]
    at ([xshift=-25mm,yshift=25mm]current page.south east) {Fabric store \textbullet\ Cutting \textbullet\ Stitching \textbullet\ Sorting\\Wash \textbullet\ Finishing \textbullet\ Retrofit \textbullet\ Dispatch};
\end{tikzpicture}

\vspace*{110mm}

{\Large\bfseries For staff working at a station on the factory floor}
