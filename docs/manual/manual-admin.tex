% ===========================================================================
%  Administrator Portal - standalone manual
%  Build:  pdflatex manual-admin.tex      (run it twice so the contents page is right)
% ===========================================================================
\documentclass[11pt,a4paper,oneside]{report}
\usepackage{style/manualstyle}

\hypersetup{pdftitle={Denim RFID Track and Trace - Administrator Portal}}

\begin{document}

\begin{titlepage}
\begin{tikzpicture}[remember picture,overlay]
  \fill[secDisp] (current page.north west) rectangle ([yshift=-95mm]current page.north east);
  ...
  \node[anchor=north west,text=white,font=\LARGE,align=left]
    at ([xshift=25mm,yshift=-66mm]current page.north west) {Administrator Portal};
  \node[anchor=south east,text=brandgrey,font=\small,align=right]
    at ([xshift=-25mm,yshift=25mm]current page.south east) {Dashboards \textbullet\ Orders \textbullet\ Reports\\Users \textbullet\ Readers \textbullet\ Audit trail};
\end{tikzpicture}

\vspace*{110mm}

{\Large\bfseries For plant management and the system administrator}
